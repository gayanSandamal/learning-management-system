...
var fluid = function () {
  var ctx, width, height, num_x, num_y, particles, grid, meta_ctx, threshold = 220, play = false, spacing = 45, radius = 50, limit = radius * 0.66, textures, num_particles
  var mouse = {
    down: false,
    x: 0,
    y: 0
  ...
  var process_image = function () {
    var imageData = meta_ctx.getImageData(0, 0, width, height), pix = imageData.data
...
export function initialize (elm, w, h) {
  return fluid.init(elm, w, h) 
}

export function clearCanvas () {
  return GLOBALCTX.clearRect(0, 0, 0, 0)
}
